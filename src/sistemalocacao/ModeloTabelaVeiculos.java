 ...
 * @author Rafael
 */
public class ModeloTabelaVeiculos extends AbstractTableModel{
    private String[] colunas = new String[]{"Marca","Modelo", "Estado", "Categoria","Valor Compra", "Placa", "Ano"};
    ...
    public ModeloTabelaVeiculos(List<Cliente> lista){
        this.lista=lista;
    }
